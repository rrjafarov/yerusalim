...
// const Logout = ({ onClose, locale }) => {
//   const handleOverlayClick = (e) => {
//     if (e.target === e.currentTarget && onClose) onClose();
//   };

//   const handleCloseClick = () => onClose && onClose();
//   const handleNoClick = () => onClose && onClose();
...
//       const redirectTo = locale === "az" ? "/login" : `/${locale}/login`;
...
//           <button className="deleteAddressCloseIcon" type="button" onClick={handleCloseClick}>
