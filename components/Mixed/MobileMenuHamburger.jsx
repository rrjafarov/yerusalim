...
const MobileMenuHamburger = ({ isOpen, onClose , contactData, token, isSuccess}) => {
  ...
  return (
    <div className={`mobileMenuHamburger ${active ? "active" : ""}`}>
      ...
      <div className="mobileMenuHamburgerAccordions">
        <ul>
          <li>
            ...
            >
              This is the static content for <strong>Best seller</strong>.
            </div>
          </li>
          ...
          <li>
            ...
            >
              This is the static content for <strong>All Products</strong>.
            </div>
          </li>
      ...
      <div className="mobileMenuHamburgerContactUs">
        <div>
          <Link href={`https://wa.me/${contactData.wp_number}`} target="_blank">WhtasApp</Link>
        </div>
