    ...
    <div className="homePageCategory">
      <div className="container">
        ...
        <div className="homePageCategoryCards">
          ...
          >
            {categoryDataTopCategories.map((category) => (
              <SwiperSlide key={category.id}>
                <div className="homePageCategoryCard">
                  <div className="homePageCategoryCardImg">
                    <Image
                      src={`${process.env.NEXT_PUBLIC_BASE_URL_IMAGE}${category.main_image}`}
                      alt={category.name}
                      width={400}
                      height={500}
                    />
                  ...
                  <div className="homePageCategoryCardTitle">
                    <Link
                      href={`/products?category=${category.url_slug}-${category.id}`}
                      className="homePageCategoryCardTitleItem"
                    >
                      <p>{category.name}</p>
