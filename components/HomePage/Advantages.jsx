...
const Advantages = () => {
  ...
  useEffect(() => {
    ...
    const observer = new IntersectionObserver(
      (entries, obs) => {
        entries.forEach((entry) => {
          if (entry.isIntersecting) {
            // 300ms gecikmə ilə animasiyanı başlat
            timeoutId = setTimeout(() => {
              setIsVisible(true);
            }, 300);
            // bir dəfə trigger olduqdan sonra observer-i dayandır
      ...
      },
      {
        root: null,
        rootMargin: "0px",
        threshold: 0.25, // 25% göründükdə trigger olacaq
      }
    );
  ...
  return (
    <div className={`advantages ${isVisible ? "is-visible" : ""}`} ref={containerRef}>
      <div className="container">
        <div className="advantagesItems">
          <h2>Benefits of shopping with us</h2>
          <div className="advantagesItemsCards">
