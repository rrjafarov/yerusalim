...
const FilterAccordion = ({
  ...
  const urlMinPrice = parseFloat(searchParams.get("min_price")) || minPrice;
  const urlMaxPrice = parseFloat(searchParams.get("max_price")) || maxPrice;

  const [priceRange, setPriceRange] = useState([urlMinPrice, urlMaxPrice]);

  // ✅ YENİ — filter dəyişəndə slider reset olur
  useEffect(() => {
...
//   // ✅ DƏYİŞDİ — minPrice/maxPrice ilə initialize olur
...
//               </div>
//             </div>
//             {/* ✅ DƏYİŞDİ — min/max limitlər verilir */}
//             <RangeSlider
//               value={priceRange}
//               onChange={setPriceRange}
//               min={minPrice}
